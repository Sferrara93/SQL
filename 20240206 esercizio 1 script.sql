...
CREATE TABLE SERVIZIO_IMPIEGATO (IdServizio INTEGER PRIMARY KEY AUTO_INCREMENT,
...
-- VISUALIZZAZIONE DATI TABELLA SERVIZIO_IMPIEGATO
SELECT * FROM SERVIZIO_IMPIEGATO;


-- INSERIMENTO DEI DATI NELLA TABELLA VIDEOGIOCO
INSERT INTO VIDEOGIOCO (Titolo, Sviluppatore, AnnoDistribuzione, CostoAcquisto, Genere, RemakeDi, CodiceStore) VALUES
...
-- VISUALIZZAZIONE DATI TABELLA VIDEOGIOCO
